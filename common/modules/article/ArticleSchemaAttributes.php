...
class ArticleSchemaAttributes {
    ...
    private function instanceAttribute() {
        ...
        $this->attributes[] = new Attribute(
            ...
            [['label' => 'Title', 'type' => 'String'], ['label' => 'Full Citation', 'type' => 'SmallText']]
        );
        ...
        $this->attributes[] = new Attribute(
            ...
            [
                ['label' => 'Title', 'type' => 'String'],
                ['label' => 'Method', 'type' => 'Array'],
                ['label' => 'Ref', 'type' => 'String'],
                ['label' => 'Full Citation', 'type' => 'SmallText'],
                ['label' => 'Data Source', 'type' => 'Array'],
                ['label' => 'Data Type', 'type' => 'Array'],
                ['label' => 'Countries', 'type' => 'Array'],
        ...
        $this->attributes[] = new Attribute(
            ...
            [['label' => 'Title', 'type' => 'String'], ['label' => 'Text', 'type' => 'SmallText']]
        );
