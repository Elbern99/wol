...
class Manager implements MenuManagerInterface {
    ...
    public function getTopMenu() {
        ...
        if (isset($this->links[MenuLinks::TOP_LINK])) {
            $content .= '<li class="item has-drop"><a href="#">For media</a><ul class="submenu"><li class="item"><a href="/find-an-expert">Find a topic spokesperson</a></li><li class="item"><a href="/press-releases">Press Releases</a></li></ul></li>';
