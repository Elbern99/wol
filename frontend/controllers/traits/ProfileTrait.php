...
trait ProfileTrait
{
    ...
    protected function renderProfile($url_key, $type = null)
    {
        ...
        $data = [
            'author' => $author,
            'country' => EavValueHelper::getValue($authorValues[$author->id], 'author_country', function($data) {
                    return $data->code;
                }, 'array'),
            ...
            'expertise' => EavValueHelper::getValue($authorValues[$author->id], 'expertise', function($data) {
            ...
            'language' => EavValueHelper::getValue($authorValues[$author->id], 'language', function($data) {
                    return $data;
                }, 'array'),
