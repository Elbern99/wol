    ...
    var article = {
        ...
        openTooltip: function(btn,parent) {
            $(btn).click(function(e) {
                ...
                cur.parent().addClass('opened-reflink').siblings().removeClass('opened-reflink');
        ...
        openReference: function(btn,parent) {
            $(btn).click(function(e) {
                ...
                article.detectNext('.reference-popup .right','.reference-popup .left');
                article.detectPrev('.reference-popup .left','.reference-popup .right');
                e.preventDefault();
            });
        },
        ...
        detectNext: function() {
            ...
            return curNext.length;
        },
        detectPrev: function() {
            var link = $('.opened-reflink'),
                curPrev = link.prev();

            return curPrev.length;

            /*if(curPrev.length > 0) {
                //curPrev.find('>a').trigger('click');
        ...
        arrowsSwitchNext: function(btnNext,btnPrev) {
            $(btnNext).click(function(e) {
                var next = article.detectNext();
                console.log(next);
            });
        },
        arrowsSwitchPrev: function(btnPrev,btnNext) {
            $(btnPrev).click(function(e) {
                var prev = article.detectPrev();
                console.log(prev);
            });
        },
