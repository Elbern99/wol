...
<div class="header-background" style="background-image: url('../images/temp/img-06.jpg');"></div>
...
<div class="container key-topics-page">
    ...
    <div class="content-inner">
        <div class="content-inner-text contact-page">
            ...
            <div class="widget-title medium">events</div>
            <ul class="post-list media-list">
                <li class="post-item media-item">
                    <a href="" class="img" style="background-image: url(https://codepo8.github.io/canvas-images-and-pixels/img/horse.png)"></a>
                    <div class="publish"><a href="">Sherrie A. Kossoudji</a></div>
        ...
        <aside class="sidebar-right">
            ...
            <div class="sidebar-widget expand-more">
                ...
                <ul class="sidebar-key-topics-list">
                    ...
                    <li><a href="">Training</a></li>
                    <li><a href="">Transitional markets in South America</a></li>
                    <li><a href="">Work hours</a></li><li><a href="">Health and safety</a></li>
                    <li><a href="">Health plans and benefits</a></li>
                    <li><a href="">Immigration</a></li>
                    <li><a href="">Law</a></li>
                    <li><a href="">Minimum wage</a></li>
