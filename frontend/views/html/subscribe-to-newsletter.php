    ...
    <div class="content-inner">
        <div class="content-inner-text">
            ...
            <form action="#">
                    ...
                    <div class="grid-line two">
                        <div class="grid-item">
                            <div class="form-item">
                                ...
                                <input type="text" class="form-control" id="first-name" value="Steve">
                            </div>
                        </div>
                    </div>
                    <div class="grid-line two">
                    ...
                    <div class="grid-line two">
                        <div class="grid-item">
                            <div class="form-item">
                                ...
                                <input type="email" class="form-control" id="email-address" value="steve@smith.com">
                ...
                <button type="submit" class="btn-blue-large">subscribe</button>
            </form>
        </div>
