		...
		<div class="content-inner-text">
			<ul class="editors-list">
				<li class="editor-item">
					<div class="img">
                        <img src="images/temp/editors/img-02.jpg" alt="">
					</div>
					<div class="name">Daniel S. Hamermesh </div>
					<div class="vacancy">Transition and emerging economies</div>
				...
				<li class="editor-item">
					...
					<div class="name">Daniel S. Hamermesh </div>
					<div class="vacancy">Editor-in-Chief</div>
					<p>Royal Holloway University of London, UK, and IZA, Germany</p>
				</li>
                <li class="editor-item">
                    <div class="img">
			...
			<ul class="editors-list">
				...
				<li class="editor-item">
					<div class="img">
						<img src="images/temp/editors/img-01.jpg" alt="">
					</div>
					<div class="name">Daniel S. Hamermesh </div>
					<div class="vacancy">Editor-in-Chief</div>
					<p>Royal Holloway University of London, UK, and IZA, Germany</p>
			...
			<a href="" class="btn-gray align-center btn-editors-more">show more</a>
		</div>
