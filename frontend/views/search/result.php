                    ...
                    <div class="filter-clone">
                        ...
                        <div class="sidebar-widget sidebar-widget-filter">
                            ...
                            <ul class="sidebar-accrodion-list">
                                <ul class="checkbox-list no-more">
                                    <li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="373" checked="checked"><span class="label-text">Program evaluation<strong class="count">(57)</strong></span></label><ul class="subcheckbox-list"><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="374"><span class="label-text">Occupational and&nbsp;classroom training<strong class="count">(10)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="375"><span class="label-text">Wage subsidies and&nbsp;in-work benefits<strong class="count">(8)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="376" checked="checked"><span class="label-text">Counseling, sanctioning, and monitoring<strong class="count">(7)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="377" checked="checked"><span class="label-text">Micro-credits and&nbsp;start-up subsidies<strong class="count">(3)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="378" checked="checked"><span class="label-text">Child-care support, early childhood education, and schooling<strong class="count">(23)</strong></span></label></li></ul></li>
                                    <li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="373" checked="checked"><span class="label-text">Program evaluation<strong class="count">(57)</strong></span></label><ul class="subcheckbox-list"><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="374"><span class="label-text">Occupational and&nbsp;classroom training<strong class="count">(10)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="375"><span class="label-text">Wage subsidies and&nbsp;in-work benefits<strong class="count">(8)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="376" checked="checked"><span class="label-text">Counseling, sanctioning, and monitoring<strong class="count">(7)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="377" checked="checked"><span class="label-text">Micro-credits and&nbsp;start-up subsidies<strong class="count">(3)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="378" checked="checked"><span class="label-text">Child-care support, early childhood education, and schooling<strong class="count">(23)</strong></span></label></li></ul></li>
                                    <li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="373" checked="checked"><span class="label-text">Program evaluation<strong class="count">(57)</strong></span></label><ul class="subcheckbox-list"><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="374"><span class="label-text">Occupational and&nbsp;classroom training<strong class="count">(10)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="375"><span class="label-text">Wage subsidies and&nbsp;in-work benefits<strong class="count">(8)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="376" checked="checked"><span class="label-text">Counseling, sanctioning, and monitoring<strong class="count">(7)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="377" checked="checked"><span class="label-text">Micro-credits and&nbsp;start-up subsidies<strong class="count">(3)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="378" checked="checked"><span class="label-text">Child-care support, early childhood education, and schooling<strong class="count">(23)</strong></span></label></li></ul></li>
                                    <li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="373" checked="checked"><span class="label-text">Program evaluation<strong class="count">(57)</strong></span></label><ul class="subcheckbox-list"><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="374"><span class="label-text">Occupational and&nbsp;classroom training<strong class="count">(10)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="375"><span class="label-text">Wage subsidies and&nbsp;in-work benefits<strong class="count">(8)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="376" checked="checked"><span class="label-text">Counseling, sanctioning, and monitoring<strong class="count">(7)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="377" checked="checked"><span class="label-text">Micro-credits and&nbsp;start-up subsidies<strong class="count">(3)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="378" checked="checked"><span class="label-text">Child-care support, early childhood education, and schooling<strong class="count">(23)</strong></span></label></li></ul></li>
                                    <li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="373" checked="checked"><span class="label-text">Program evaluation<strong class="count">(57)</strong></span></label><ul class="subcheckbox-list"><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="374"><span class="label-text">Occupational and&nbsp;classroom training<strong class="count">(10)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="375"><span class="label-text">Wage subsidies and&nbsp;in-work benefits<strong class="count">(8)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="376" checked="checked"><span class="label-text">Counseling, sanctioning, and monitoring<strong class="count">(7)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="377" checked="checked"><span class="label-text">Micro-credits and&nbsp;start-up subsidies<strong class="count">(3)</strong></span></label></li><li class=""><label class="def-checkbox light item-filter-box"><input type="checkbox" name="filter_subject_type[]" value="378" checked="checked"><span class="label-text">Child-care support, early childhood education, and schooling<strong class="count">(23)</strong></span></label></li></ul></li>
