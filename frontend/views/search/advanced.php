        ...
        <?php $form = ActiveForm::begin(['class' => 'header-search-form']); ?>
            ...
            <div class="finding-results">
                ...
                <div class="my-tags-holder">
                    ...
                    <?= Html::activeHiddenInput($search, 'all_words', ['class'=>"form-control my-single-field", 'placeholder' => 'Enter words separated with spaces']) ?>
                    </div>
                </div>
                ...
                <div class="my-tags-holder">
                    ...
                    <?= Html::activeHiddenInput($search, 'one_more_words', ['class'=>"form-control my-single-field", 'placeholder' => 'Enter words separated with spaces']) ?>
                    </div>
                </div>
            </div>
            ...
            <div class="excluding-results">
                ...
                <div class="my-tags-holder">
                    ...
                    <div class="form-control-holder">
                    <ul class="my-tags-list one-or-more-my-tags-list"></ul>
                    <?= Html::activeHiddenInput($search, 'any_words', ['class'=>"my-single-field form-control", 'placeholder' => 'Enter words separated with spaces']) ?>
                    </div>
                </div>
            </div>
