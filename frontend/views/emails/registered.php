...
<p>
    ...
    <span style="background:lime"><a href="<?= Url::to('/my-account', true) ?>" target="_blank"><?= Url::to('/my-account', true) ?></a></span> or
    <span style="background:lime"><a href="<?= Url::to(['/unsubscribe', 'number' => $subscriber], true) ?>" target="_blank">unsubscribe</a></span> from all IZA World of Labor emails. </span>
</p>
<?php $this->endContent(); ?>