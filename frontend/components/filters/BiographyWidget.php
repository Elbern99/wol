...
class BiographyWidget extends Widget {

    public $param;
    protected $prefix = 'filter_biography_type';
    ...
    public function init() {
        ...
        $this->param = $this->param['biography'];
    }
    ...
    private function getContent() {
        ...
        foreach ($this->param['data'] as $item) {
            ...
            if ($selected) {
                ...
                $content .= Html::tag('span', $item['name'], ['class' => "label-text"]);
            } else {
