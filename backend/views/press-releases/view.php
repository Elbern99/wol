...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.menu', 'Press Releases'), 'url' => Url::toRoute('/press-releases')];
    ...
    <div class="row content">
        <div class="col-sm-12 sidenav">
            <?php $form = ActiveForm::begin(); ?>
                ...
                <?=
                $form->field($model, 'pdf_link')->fileInput()->widget(FileInput::classname(), [
                    'options' => ['multiple' => false],
                    'pluginOptions' => [
...
$this->registerJs(<<<JS
   $('#remove-link').click(function (e) {
      ...
      $.post("$url", { id: $model->id }, function( data ) {
         alert(data);
         $('.image-link .file-caption-name').html('<i class="glyphicon glyphicon-file kv-caption-icon"></i>');
      });
   });
JS
