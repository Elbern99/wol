...
<p>
    ...
    or
    <a href="<?= \Yii::$app->frontendUrlManager->createAbsoluteUrl('/unsubscribe?number='.$subscriber->code, true) ?>" target="_blank">unsubscribe</a> from all IZA World of Labor emails. </span>
</p>
<p>
