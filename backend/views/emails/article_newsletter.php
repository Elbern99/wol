...
<p><span style="font-size:10.0pt;font-family:'Lucida Sans',sans-serif">You can manage your article alert preferences here (<a href ="<?= Url::to('/my-account', true) ?>">link</a>).</span></p>
...
<p>
    ...
    <a href="<?= Url::to('/my-account', true) ?>" target="_blank">My Account</a>
    or
